...
Le menu est divisé en plusieurs modules. On peut voir les catégories **Web**, **Fichier**, **Configuration utilisateur**
et **Aide** et, par exemple, les modules **Page**, **Voir**, **Liste**, **Info**, **Fonctions**, **Fichiers**. Les
catégories et modules disponibles peuvent différer d'une instance TYPO3 à une autre en fonction de votre projet.
